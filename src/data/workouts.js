...
export const EXERCISES = {
  ...
  pushUps: {
    ...
    video: "https://www.youtube.com/watch?v=IODxDxX7oi4", channel: "Jeff Nippard",
  ...
  pikePushUps: {
    ...
    video: "https://www.youtube.com/watch?v=PdnTvBqMPKk", channel: "FitnessFAQs",
  ...
  diamondPushUps: {
    ...
    video: "https://www.youtube.com/watch?v=J0DnG1_S92I", channel: "Athlean-X",
  },
  // ── Pull ─────────────────────────────────────────────────────────────
  tableRows: {
    ...
    video: "https://www.youtube.com/watch?v=rloXYB8M3vU", channel: "Calisthenic Movement",
  },
  // ── Legs ─────────────────────────────────────────────────────────────
  squats: {
    ...
    video: "https://www.youtube.com/watch?v=aclHkVaku9U", channel: "Athlean-X",
  },
  jumpSquats: {
    ...
    video: "https://www.youtube.com/watch?v=CVaEhXotL7M", channel: "Athlean-X",
  },
  bulgarianSplitSquat: {
    ...
    video: "https://www.youtube.com/watch?v=2C-uNgKwPLE", channel: "Jeff Nippard",
  },
  reverseLunges: {
    ...
    video: "https://www.youtube.com/watch?v=xrPteyQLGAo", channel: "Athlean-X",
  },
  singleLegRDL: {
    ...
    video: "https://www.youtube.com/watch?v=UN4g7oVGFJI", channel: "Jeff Nippard",
  },
  gluteBridges: {
    ...
    video: "https://www.youtube.com/watch?v=OUgsJ8-Vi0E", channel: "Calisthenic Movement",
  },
  // ── Core ─────────────────────────────────────────────────────────────
  plank: {
    ...
    video: "https://www.youtube.com/watch?v=pSHjTRCQxIw", channel: "Jeff Nippard",
  ...
  mountainClimbers: {
    ...
    video: "https://www.youtube.com/watch?v=nmwgirgXLYM", channel: "Calisthenic Movement",
  },
};
...
export const BBARS = {
  chinUps: {
    ...
    video: "https://www.youtube.com/watch?v=eGo4IYlbE5g", channel: "FitnessFAQs",
  },
  dips: {
  ...
  deadHang: {
    ...
    video: "https://www.youtube.com/watch?v=a-V9_UHzCEU", channel: "Calisthenic Movement",
  },
  scapularPulls: {
    ...
    video: "https://www.youtube.com/watch?v=NBY9-kTuHEk", channel: "FitnessFAQs",
  },
  deepSquatHold: {
    ...
    video: "https://www.youtube.com/watch?v=yNpVGWiPsA4", channel: "Athlean-X",
  },
  lSitTuck: {
    ...
    video: "https://www.youtube.com/watch?v=IUZJoSP66HI", channel: "FitnessFAQs",
  },
  hangingKneeRaises: {
    ...
    video: "https://www.youtube.com/watch?v=hdng3Nm1x_E", channel: "Athlean-X",
  },
};
...
export const WEEKLY_SCHEDULE = {
  busy: {
    Mon: { session: SESSIONS.busyFullBody, note: "Anthropic course 5pm" },
    Tue: { session: SESSIONS.rest,         note: "Rest / walk" },
    Wed: { session: SESSIONS.busyFullBody, note: "Standard office day" },
    Thu: { session: SESSIONS.rest,         note: "HeyTea + social 6pm" },
    Fri: { session: SESSIONS.busyFullBody, note: "Claude project 6pm" },
    Sat: { session: SESSIONS.rest,         note: "Weekend — flexible" },
    Sun: { session: SESSIONS.rest,         note: "Meal prep day" },
  },
  regular: {
    Mon: { session: SESSIONS.regularUpper,    note: "Anthropic course 5pm" },
    Tue: { session: SESSIONS.regularLower,    note: "Standard office day" },
    Wed: { session: SESSIONS.regularCore,     note: "Standard office day" },
    Thu: { session: SESSIONS.regularUpper,    note: "HeyTea + social 6pm" },
    Fri: { session: SESSIONS.regularFullBody, note: "Claude project 6pm" },
    Sat: { session: SESSIONS.rest,            note: "Weekend — flexible" },
    Sun: { session: SESSIONS.rest,            note: "Meal prep day" },
  },
};
